    ...
    private class insertarUsuarios extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... strings) {
            ...
            try {
                ...
                EntityUtils.toString(new DefaultHttpClient().execute(new HttpPost("https://shessag.000webhostapp.com/insertarUsuarioRespDeSeguridad.php?nombre_usuario="+nombreusuariobar_usuario+"&nombre_propio="+nombrepropiobar_usuario+"&contrasena="+contrasenabar_usuario+"&rol="+rol_insertar_usuario+"&respuesta_uno="+respuesta1bar_usuario+"&respuesta_dos="+respuesta2bar_usuario+"&respuesta_tres="+respuesta3bar_usuario)).getEntity());
