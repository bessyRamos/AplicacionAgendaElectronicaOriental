...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    final String CREAR_TABLA_CONTACTOS = "create table Contactos(id_contacto INTEGER PRIMARY KEY  , nombre_organizacion TEXT NOT NULL, numero_fijo TEXT," +
            " numero_movil TEXT, direccion TEXT NOT NULL, imagen INTEGER DEFAULT "+imagenPredeterminada+", e_mail TEXT DEFAULT 'No Disponible', descripcion_organizacion TEXT NOT NULL, latitud REAL, " +
            "longitud REAL, id_usuario INTEGER, id_categoria INTEGER, id_estado INTEGER, id_region INTEGER, FOREIGN KEY(id_usuario) REFERENCES Usuarios(id_usuario)," +
   ...
   final String INSERTAR_USUARIOS="INSERT INTO Usuarios values(1,'Admin','Administrador','admin123',1,1), (2,'cliente1','nombreCliente','cliente123',1,1), (3,'cliente2','nombreCliente2','cliente123',2,1)";
    ...
    final String INSERTAR_CATEGORIAS = "INSERT INTO Categorias" +
            ...
            "(5,'Hotelería y Turismo',"+R.drawable.hoteleria_y_turismo+")," +
            ...
            "(9,'Bienes y Raíces',"+R.drawable.biene_y_raises+")," +
    ...
    final String INSERTAR_CONTACTOS = "INSERT INTO Contactos" +
           ...
           "(3,'Centro Tecnico Vocacional Pedro Nufio','2763-3195','', 'Barrio El Quiquisque', '', 'Instituto Público', 14.011955, -86.569433," +
            " 1, 2,2, 3)," +
           "(4,'Instituto Teodoro Rodas Valle','2763-3050','3219-6497', 'Barrio las Flores', 'loborams@yahoo.com', 'Instituto privado',14.028581, -86.566637," +
            " 1, 2,2, 3),"+
            "(5,'Instituto Técnico Alejandro Flores','2793-4123','', 'Col.Los Montesitos, Salida Danlí', '', 'Instituto Público',13.874814 ,-86.554105," +
            " 1, 2,2, 4),"+
            "(6,'Farmacia Siman','2793-5151','', 'Barrio San Sebastian', '', 'Cuenta con servicio a domicilio',13.863657, -86.552658," +
            " 1, 3,2, 4),"+
            "(7,'Farmacia del Ahorro','2763-2787','', 'Barrio El Centro Edificio Astrovisión, Salida Danlí', '', 'Cuenta con servicio a domicilio',14.033952,-86.572866," +
            " 1, 3,2, 3),"+
            "(8,'Hospital Gabriela Alvarado','2763-5824','', 'San Marcos abajo, calle panamericana', '', 'Trabajamos 24 hrs',13.991433,-86.568148," +
            " 1, 3,2, 3),"+
            "(9,'BANHCAFE','2763-2402','', 'Barrio Tierra Blanca', '', 'Servicios financieros',14.0337981,-86.56783999999999," +
            " 1, 4, 2, 3),"+
            "(10,'Banco Atlántida','2793-4200','', 'El paraíso frente a plaza Ramón Ignacio Díaz, Bo.San Isidro', '', 'Servicios financieros',13.861808,-86.552455," +
            " 1, 4, 2, 4),"+
            "(11,'Hotel La Esperanza','2763-2106','', 'Bo.Tierra Santa', '', 'Servicios de hoteleria', 14.02976,-86.570383," +
            " 1, 5, 2, 3),"+
            "(12,'Hotel y Restaurante Mario Chávez','2793-4345','', 'Calle principal quinta avenida, El Paraíso', '', 'Servicios de hoteleria y comida',13.864908 ,-86.55265," +
            " 1, 5, 2, 4),"+
            "(13,'Finca Santa Emilia','','9842-7586', 'Siete km del parque central de Danlí, una reserva natural', '', 'turismo',14.025889,-86.540083," +
            " 1, 5, 2, 3),"+
            "(14,'Instituto de la Propiedad','2763-0473','', 'Bo.Oriental', '', 'Registro de bienes',14.032275,-86.563461," +
            " 1, 6, 2, 3),"+
            ...
            " 1, 6, 2, 3),"+
            "(16,'Plaza Unicentro','2763-3552','', 'Bo.el centro calle del comercio frente a hondutel', 'jeany_salinas@hotmail.com', 'adquiere un bien',14.031468, -86.571082," +
            " 1, 7, 2, 3),"+
            "(17,'Carrión','2763-2331','', 'frente a Casa de la Cultura', '', 'servicio de bienes',14.03006 ,-86.567591," +
            " 1, 7, 2, 3),"+
            "(18,'Oficina Postal Danlí Paraíso','2763-2036','', 'Bo. El Centro frente al Parque Centenario', '', ' envio',14.030837,-86.568162," +
            " 1, 8, 2, 3),"+
            "(19,'Cámara de Comercio E Industrias de Danlí (CCID)','2763-2061','', 'Colonia Gualiquemes por terminal de buses contiguo ala Plaza San Miguel en Boulevard La Democracia', 'cidedanli@yahoo.com cidedanli@hotmail.com', ' Comercio',14.068263,-86.570836," +
            " 1, 8, 2, 3),"+
            "(20,'Inmobiliaria y Constructora El Protector','27634746','', 'Media cuadra al norte del parque central entre banco Los Trabajadores y La Despensa (72,02 km)', '','Agente de bienes raíces',14.031517,-86.566369," +
            " 1, 9, 2, 3),"+
            "(21,'Despacho Legal Lic. Hector Paguaga','','9767-3875', 'Barrio Tierra Blanca', '', ' Abogado',14.033917,-86.568712," +
            " 1, 10, 2, 3),"+
            "(22,'Colegio de Abogados Capitulo Danli','','', 'Frente al Triangulo salida al paraíso a la par de Instituto Técnico Pedro Nufio', '', 'Institución educativa',14.014148,-86.569564," +
            " 1, 10, 2, 3),"+
            "(23,'FUNERALES DIVINA MISERICORDIA','2763-6798','', 'V-216  Danlí', '', 'disponibilidad de local', 14.019116,-86.569615," +
            " 1, 11, 2, 3),"+
            "(24,'Funerales Puerta Al Cielo','2763-2588','', 'Danlí', '', 'disponibilidad de local',14.031384 ,-86.565499," +
            " 1, 11, 2, 3),"+
            "(25,'Posta Policiaca','2763-2224','', 'Danlí salida a Jamastran', '', 'disponible las 24 horas',14.050158, -86.536660," +
            " 1, 1, 2, 3),"+
            "(26,'Instituto Departamental De Oriente ','2763-2124','', 'Bo. El Carmelo', '', 'Instituto público',14.0363437,-86.57605389999998," +
            " 1, 2, 2, 3),"+
            ...
            " 1, 4, 2, 3),"+
            "(30,'BANADESA','2793-4241','', 'El Paraíso','', 'Banco',14.090723,-86.561815," +
            " 1, 4, 2, 4),"+
            "(31,'Hotel La Casona','',' 9492-8526', 'Cuesta el Dorado salida a Tegucigalpa', '', 'Hotel',14.025642,-86.585041," +
            " 1, 5, 2, 3),"+
            "(32,'Los Llanos Restaurante Turístico','','', 'El Paraíso El Paraíso', '', 'Hotel',14.073693,-86.418731," +
            " 1, 5, 2, 4),"+
            "(33,'IHMA Danlí','','', 'Las Colinas', '', 'Instituciones Públicas',14.022516,-86.568433," +
            " 1, 6, 2, 3),"+
            ...
            "1,8,2,3),"+
            "(37,'Comercial la Unión','2763-2357','','Bo. Abajo','','Comercial',14.028761,-86.572414,"+
            "1,7,2,3),"+
