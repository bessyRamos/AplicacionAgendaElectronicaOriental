...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    final String CREAR_TABLA_CONTACTOS = "create table Contactos(id_contacto INTEGER PRIMARY KEY  , nombre_organizacion TEXT NOT NULL, numero_fijo TEXT," +
            " numero_movil TEXT, direccion TEXT NOT NULL, imagen INTEGER DEFAULT "+imagenPredeterminada+", e_mail TEXT DEFAULT 'No Disponible', descripcion_organizacion TEXT NOT NULL, latitud INTEGER, " +
            "longitud INTEGER, id_usuario INTEGER, id_categoria INTEGER, id_estado INTEGER, id_region INTEGER, FOREIGN KEY(id_usuario) REFERENCES Usuarios(id_usuario)," +
   ...
   final String INSERTAR_USUARIOS="INSERT INTO Usuarios values(1,'Admin','Administrador','admin123',1,1), (2,'cliente1','nombreCliente','cliente123',2,1), (3,'cliente2','nombreCliente2','cliente123',2,1)";
    ...
    final String INSERTAR_CATEGORIAS = "INSERT INTO Categorias" +
            ...
            "(9,'Bienes y Raices',"+R.drawable.biene_y_raises+")," +
    ...
    final String INSERTAR_CONTACTOS = "INSERT INTO Contactos" +
            ...
            " 1, 1,2, 4)," +
            "(3,'Centro Técnico Vocacional Pedro Nufio','2763-3195','', 'Barrio El Quiquisque', '', 'Instituto Público', 14.011955, -86.569433," +
            " 1, 2,2, 3)," +
            "(4,'Instituto Teodoro Rodas Valle','2763-3050','3219-6497', 'Barrio las Flores', 'loborams@yahoo.com', 'Instituto privado',,," +
            " 1, 2,2, 3),"+
            "(5,'Instituto Técnico Alegandro Flores','2793-4123','', 'Col.Los Montesitos, Salida Danlí', '', 'Instituto Público',13.874814 ,-86.554105," +
            " 1, 2,2, 4),"+
            "(6,'Farmacia Cimar','2763-2115','', 'Barrio San Sebastian', '', 'Cuenta con servicio a domicilio',,," +
            " 1, 3,2, 4),"+
            "(7,'Farmacia del Ahorro','2763-2787','', 'Barrio El Centro Edificio Astrovisión, Salida Danlí', '', 'Cuenta con servicio a domicilio',14.030842,-86.569456," +
            " 1, 3,2, 3),"+
            "(8,'Hospital Gabriela Alvarado','2763-5824','', 'San Marcos abajo, calle panamericana', '', 'Trabajamos 24 hrs',13.991433,-86.568148," +
            " 1, 3,2, 3),"+
            "(9,'BANHCAFE','2763-2402','', 'Barrio Tierra Blanca', '', 'Servicios financieros',14.033798,-86.56784," +
            " 1, 4, 2, 3),"+
            "(10,'Banco Atlantida','2793-4200','', 'El paraiso frente a plaza Ramón Ignacio Díaz, Bo.San Isidro', '', 'Servicios financieros',,," +
            " 1, 4, 2, 4),"+
            ...
            " 1, 7, 2, 3),"+
            "(17,'Carrión','2763-2331','', 'frente a Casa de la Cultura', '', 'servio de bienes',14.03006 ,-86.567591," +
            " 1, 7, 2, 3),"+
            "(18,'Oficina Postal Danlí Paraíso','2763-2036','', 'Bo. El Centro frente al Parque Centenario', '', ' envio',14.030837,-86.568162," +
            " 1, 8, 2, 3),"+
            "(19,'Cámara de Comercio E Industrias de Danlí (CCID)','2763-2061','', 'Colonia Gualiquemes por terminal de buses contiguo ala Plaza San Miguel en Boulevard La Democracia.', 'cidedanli@yahoo.com cidedanli@hotmail.com', ' Comercio',,," +
            " 1, 8, 2, 3),"+
            "(20,'Inmobiliaria y Constructora El Protector','27634746','', 'Media cuadra al norte del parque central entre banco Los Trabajadores y La Despensa (72,02 km)', '','Agente de bienes raíces',,," +
            " 1, 9, 2, 3),"+
            "(21,'Despacho Legal Lic. Hector Paguaga','','9767-3875', 'Barrio Tierra Blanca', '', ' Abogado',,," +
            " 1, 10, 2, 3),"+
            "(22,'Colegio de Abogados Capitulo Danli','','', 'Frente al Triangulo salida al paraiso a la par de Instituto Técnico Pedro Nufio', '', '',14.014148,-86.569564," +
            " 1, 10, 2, 3),"+
            ...
            " 1, 11, 2, 3),"+
            "(25,'Policía de tránsito','2763-2224','', 'Danlí salida a Jamastran', '', 'disponible las 24 horas',,," +
            " 1, 1, 2, 3),"+
            ...
            " 1, 4, 2, 3),"+
            "(30,'BANADESA','2793-4241','', 'El Paraíso','', 'Banco',,," +
            " 1, 4, 2, 4),"+
            "(31,'Hotel La Casona','',' 9492-8526', 'Cuesta el Dorado salida a Tegucigalpa', '', 'Hotel',14.025642, -86.585041," +
            " 1, 5, 2, 3),"+
            "(32,'Los Llanos Restaurante Turístico','','', 'El Paraiso El Paraiso', '', 'Hotel',14.073693,-86.418731," +
            " 1, 5, 2, 4),"+
