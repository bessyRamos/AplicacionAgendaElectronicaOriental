...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    final String CREAR_TABLA_CATEGORIAS = "create table Categorias(id_categoria INTEGER AUTOINCREMENT PRIMARY KEY, nombre_categoria TEXT NOT NULL, imagen_categoria INT)";
    ...
    final String CREAR_TABLA_CONTACTOS = "create table Contactos(id_contacto INTEGER AUTOINCREMENT PRIMARY KEY, nombre_organizacion TEXT NOT NULL, numero_fijo TEXT," +
