...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
   ...
   final String INSERTAR_USUARIOS="INSERT INTO Usuarios values(1,'Admin','Administrador','admin123',1,1), (2,'cliente1','nombreCliente','cliente123',2,1), (3,'cliente2','nombreCliente2','cliente123',2,1)";
    ...
    final String INSERTAR_CONTACTOS = "INSERT INTO Contactos" +
            ...
            " 1, 2,2, 3),"+
            "(6,'Instituto Técnico Alejandro Flores','2793-4123','', 'Col.Los Montesitos, Salida Danlí', '', 'Instituto Público',13.874814 ,-86.554105," +
            " 1, 2,2, 4),"+
            ...
            " 1, 4, 2, 3),"+
            "(11,'Banco Atlántida','2793-4200','', 'El paraíso frente a plaza Ramón Ignacio Díaz, Bo.San Isidro', '', 'Servicios financieros','',''," +
            " 1, 4, 2, 4),"+
            ...
            " 1, 6, 2, 3),"+
            "(16,'Secretaría Agricultura Ganaderia','2763-2112','98543113', 'Salida El Paraíso frente al instituto Cosme Garcia', 'valdivita_10@yahoo.com', ' Asesoría ', '14.023419','-86.569327'," +
            " 1, 6, 2, 3),"+
            "(17,'Plaza Unicentro','2763-3552','', 'Bo.el centro calle del comercio frente a hondutel', 'jeany_salinas@hotmail.com', 'adquiere un bien','14.031468', '-86.571082'," +
            " 1, 7, 2, 3),"+
            ...
            " 1, 8, 2, 3),"+
            "(21,'Inmobiliaria y Constructora El Protector','27634746','', 'Media cuadra al norte del parque central entre banco Los Trabajadores y La Despensa (72,02 km)', '',' Bienes Raíces','',''," +
            " 1, 9, 2, 3),"+
            "(22,'Despacho Legal Lic. Hector Paguaga','','9767-3875', 'Barrio Tierra Blanca', '', ' Abogado','',''," +
            " 1, 10, 2, 3),"+
            "(23,'Colegio de Abogados Capitulo Danlí','','', 'Frente al Triangulo salida al paraíso a la par de Instituto Técnico Pedro Nufio', '', '','14.014148','-86.569564'," +
            " 1, 10, 2, 3),"+
            ...
            " 1, 5, 2, 3),"+
            "(33,'Los Llanos Restaurante Turístico','','', 'El Paraíso El Paraíso', '', 'Hotel','14.073693','-86.418731'," +
            " 1, 5, 2, 4),"+
            ...
            "1,7,2,3),"+
            "(39,'Residencial Vereda Real','2763-6274','99782015','Carretera panamericana entrada principal Col.La Ceibita 100 metros a mano derecha de la Iglesia Gran Comision','@residencialveredarealdanli','Bienes y Raises','14.015085','-86.574649',"+
            "1,9,2,3),"+
